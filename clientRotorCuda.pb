...
Procedure runcuBitCrack(*vanity.CrackStructure)
  ...
  *vanity\isok=1
  ...
  EndIf
  *vanity\Compiler = RunProgram(settings("1")\Progname, params$,"",#PB_Program_Open)  
  If *vanity\Compiler
    ...
    If *vanity\killapp=0
      ...
      *vanity\isok =  0;ProgramExitCode(*vanity\Compiler)
    Else
...
settings("1")\name="Friend"
settings("1")\pass="x"
settings("1")\Progname="Rotor-Cuda.exe"
...
; EnableThread
; EnableXP
; Executable = clientRotorCudaX64.exe
; DisableDebugger